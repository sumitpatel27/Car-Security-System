...
void SendMessage()
{
  ...
  mySerial.println("AT+CMGS=\"+918460502706\"\r"); // Replace x with mobile number
  delay(1000);
...
void MakeCall()
{
  mySerial.println("ATD+918460502706;"); // ATDxxxxxxxxxx; -- watch out here for semicolon at the end!!
